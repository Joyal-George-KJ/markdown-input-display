...
var markdownShortcuts = {
    ...
    ol: {
        ...
        icon: function () { return ((0, jsx_runtime_1.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", className: "bi bi-list-ol", viewBox: "0 0 16 16", children: [(0, jsx_runtime_1.jsx)("path", { "fill-rule": "evenodd", d: "M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5" }), (0, jsx_runtime_1.jsx)("path", { d: "M1.713 11.865v-.474H2c.217 0 .363-.137.363-.317 0-.185-.158-.31-.361-.31-.223 0-.367.152-.373.31h-.59c.016-.467.373-.787.986-.787.588-.002.954.291.957.703a.595.595 0 0 1-.492.594v.033a.615.615 0 0 1 .569.631c.003.533-.502.8-1.051.8-.656 0-1-.37-1.008-.794h.582c.008.178.186.306.422.309.254 0 .424-.145.422-.35-.002-.195-.155-.348-.414-.348h-.3zm-.004-4.699h-.604v-.035c0-.408.295-.844.958-.844.583 0 .96.326.96.756 0 .389-.257.617-.476.848l-.537.572v.03h1.054V9H1.143v-.395l.957-.99c.138-.142.293-.304.293-.508 0-.18-.147-.32-.342-.32a.33.33 0 0 0-.342.338zM2.564 5h-.635V2.924h-.031l-.598.42v-.567l.629-.443h.635z" })] })); },
    },
    ul: {
        transform: function (s) { return "-".concat(s); },
        icon: function () { return ((0, jsx_runtime_1.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", className: "bi bi-list-ul", viewBox: "0 0 16 16", children: (0, jsx_runtime_1.jsx)("path", { "fill-rule": "evenodd", d: "M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2" }) })); },
    },
};
function MarkdownInput() {
    var inputRef = (0, react_1.useRef)(null);
    var _a = (0, react_1.useState)("Something on progress and is going well"), md = _a[0], setMd = _a[1];
    var _b = (0, react_1.useState)(false), previewToggle = _b[0], setPreviewToggle = _b[1];
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "markdown-wrapper", children: (0, jsx_runtime_1.jsxs)("div", { className: "markdown-editor", children: [(0, jsx_runtime_1.jsxs)("div", { className: "toolbar", children: [(0, jsx_runtime_1.jsx)("div", { className: "toolbar-buttons", children: Object.keys(markdownShortcuts).map(function (val, ind) { return ((0, jsx_runtime_1.jsx)("button", { onClick: handleClick, className: "toolbar-btn", id: val, children: markdownShortcuts[val].icon() }, ind)); }) }), (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)("button", { onClick: function () { return setPreviewToggle(!previewToggle); }, className: "toolbar-btn preview", children: (0, jsx_runtime_1.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", className: "bi bi-play-fill", viewBox: "0 0 16 16", children: (0, jsx_runtime_1.jsx)("path", { d: "m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" }) }) }) })] }), previewToggle && ((0, jsx_runtime_1.jsx)(MarkdownPreview_1.default, { onClose: function () { return setPreviewToggle(!previewToggle); }, md: md })), (0, jsx_runtime_1.jsx)("textarea", { ref: inputRef, value: md, onChange: function (e) { return setMd(e.target.value); }, className: "markdown-input", name: "markdown-input", id: "markdown-input", "aria-label": "markdown input", spellCheck: "false", placeholder: "Write what you want here!", rows: 10, cols: 100 })] }) }));
}
